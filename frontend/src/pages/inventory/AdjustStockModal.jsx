...
const AdjustStockModal = ({ product, branchId, onClose, onSuccess }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="bg-slate-100 dark:bg-slate-700 p-4 rounded-lg mb-4 flex justify-between items-center">
        <div>
          <p className="text-sm text-slate-600 dark:text-slate-400">Producto</p>
          <p className="font-bold text-slate-900 dark:text-slate-100">{product.product_name}</p>
        </div>
